...
extern void asm_poly_basemul_kara(int16_t *r, const int16_t *a, const int16_t *b, const int16_t *zeta);
extern void asm_poly_tomont(int16_t r[KYBER_N]);
extern void asm_poly_barrett(int16_t r[KYBER_N]); 
extern int16_t asm_ntt_merging(int16_t* a);
extern int16_t asm_invntt_merging(int16_t* a);
